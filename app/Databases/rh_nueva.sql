...
INSERT INTO `directores_areas` VALUES (5, 706, 'IND', 'DOIT', '2019-06-06 10:35:06', '2019-06-06 10:35:10');
...
INSERT INTO `incidencias` VALUES (120, 2150, 710, '2019-09-06', '2019-09-06', NULL, 2, NULL, 'CUALQUIERA', 750, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2019-09-06 09:05:44', '2019-09-06 09:05:44', NULL, 'SOLICITADO', 0, NULL, 'ADMIN', NULL, NULL, NULL, 9, 'incidencias/evidencia_120/evidencia_120.xlsx');
...
) ENGINE = InnoDB AUTO_INCREMENT = 492 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2213 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `usuario_permisos` VALUES (1400, 32, 707, NULL, '2019-07-03 10:41:02', '2019-07-03 10:41:02');
...
INSERT INTO `usuario_permisos` VALUES (1553, 51, 82, NULL, '2019-07-03 12:41:22', '2019-07-03 12:41:22');
INSERT INTO `usuario_permisos` VALUES (1554, 52, 82, NULL, '2019-07-03 12:41:22', '2019-07-03 12:41:22');
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `vista_empleados_baja` AS (select `rh`.`empleados`.`id` AS `id`,`rh`.`empleados`.`empleado_nombre` AS `empleado_nombre`,`rh`.`empleados`.`empleado_apaterno` AS `empleado_apaterno`,`rh`.`empleados`.`empleado_amaterno` AS `empleado_amaterno`,`rh`.`empleados`.`calle` AS `calle`,`rh`.`empleados`.`num_exterior` AS `num_exterior`,`rh`.`empleados`.`num_interior` AS `num_interior`,`rh`.`empleados`.`colonia` AS `colonia`,`rh`.`empleados`.`municipio` AS `municipio`,`rh`.`empleados`.`cp` AS `cp`,`rh`.`empleados`.`estado` AS `estado`,`rh`.`empleados`.`nss` AS `nss`,`rh`.`empleados`.`curp` AS `curp`,`rh`.`empleados`.`rfc` AS `rfc`,`rh`.`empleados`.`id_solicitud` AS `id_solicitud` from `empleados` where `rh`.`empleados`.`empleado_estatus` = 'BAJA');
