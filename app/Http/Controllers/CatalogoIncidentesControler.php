...
// MOD:SAM,  Controlador para llenar  los datos de los Dropdown con los catalogos de selecion.
...
class CatalogoIncidentesControler extends Controller
{
    /**
    *
    * RULES
    ...
    **/
    ...
    public function create()
    {
        ...
        return view('nuevas.idex',['clientes'=>$clientes]);
