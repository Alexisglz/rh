...
var table = $('#darbaja-table').DataTable({
    ...
    columns: [
        ...
        {
            data: 'baja_definitiva',
            name: 'baja_definitiva',
            orderable: false,
            searchable: false,
        ...
        {data: 'WBS', name: 'WBS', className: 'text-center common'},
        {
            ...
            orderable: false,
            searchable: false,
            className: "cita_v text-center common"
        },
        {
            data: 'baja_computo',
            name: 'baja_computo',
            orderable: false,
            searchable: false,
            className: "comp_v text-center common"
        },//6
        {
            data: 'baja_celular',
            name: 'baja_celular',
            orderable: false,
            searchable: false,
            className: "cel_v text-center common"
        },
        {
            data: 'baja_auto',
            name: 'baja_auto',
            orderable: false,
            searchable: false,
            className: "auto_v text-center common"
        },
        {
            data: 'baja_almacen',
            name: 'baja_almacen',
            orderable: false,
            searchable: false,
            className: " alma_v text-center common"
        },
        {
            data: 'baja_credencial',
            name: 'baja_credencial',
            orderable: false,
            searchable: false,
            className: "cred_v text-center common"
        },
        {
            data: 'pago_finiquito',
            name: 'pago_finiquito',
            orderable: false,
            searchable: false,
            className: "fini_v text-center common"
        },
...
$('#darbaja-table tbody').on('click', '.comment_n', function () {
    ...
    switch (type) {
        case 'Cita':
            ...
            break;
        case 'Computo':
            cantidad = data.deuda_compu == 0 ? 0 : data.deuda_compu;
            ade = '<span class="col-md-12 font-weight-bold">Adeudo: </span><input id="comment_d" min="0" class="form-control text-center" value="' + cantidad + '">';
            obs = data.obs_compu == null ? '' : data.obs_compu;
            editar = baja_compu == 1 ? true : false;
            break;
        case 'Celular':
            cantidad = data.deuda_cel == 0 ? 0 : data.deuda_cel;
            ade = '<span class="col-md-12 font-weight-bold">Adeudo: </span><input id="comment_d" min="0" class="form-control text-center" value="' + cantidad + '">';
            obs = data.obs_cel == null ? '' : data.obs_cel;
            editar = baja_cel == 1 ? true : false;
            break;
        case 'Auto':
            cantidad = data.deuda_auto == 0 ? 0 : data.deuda_auto;
            ade = '<span class="col-md-12 font-weight-bold">Adeudo:</span><input id="comment_d" min="0" class="form-control text-center" value="' + cantidad + '">';
            obs = data.obs_auto == null ? '' : data.obs_auto;
            editar = baja_coche == 1 ? true : false;
            break;
        case 'Almacen':
            cantidad = data.deuda_alma == 0 ? 0 : data.deuda_alma;
            ade = '<span class="col-md-12 font-weight-bold">Adeudo: </span><input id="comment_d" min="0" class="form-control text-center" value="' + cantidad + '">';
            obs = data.obs_alma == null ? '' : data.obs_alma;
            editar = baja_herra == 1 ? true : false;
            break;
        case 'Credencial':
            cantidad = data.deuda_cred == 0 ? 0 : data.deuda_cred;
            ade = '<span class="col-md-12 font-weight-bold">Adeudo: </span><input id="comment_d" min="0" class="form-control text-center" value="' + cantidad + '">';
