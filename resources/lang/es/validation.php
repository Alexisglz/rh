    ...
    */
    ...
    'custom' => [
        'fecha_i' => [
            ...
            'before_or_equal'=>'La fecha inicial no puede ser mayor al corte de la quincena',
            'after_or_equal'=>'La fecha inicial debe corresponder a la quincena en curso',
        ], 
        'fecha_f'=>[
            'required'=>'La fecha final es obligatoria',
            'before_or_equal'=>'La fecha final debe estar dentro de la quincena actual',
            'after_or_equal'=>'La fecha final debe ser mayor a la fecha inicial y no puede ser mayor al corte de la quincena'
        ], 
        'dias'=>[
            'required'=>'El campo duracion en dias es obligatorio',
        ],
        'id_empleado'=>[
            'required'=>'El campo empleado es obligatorio',
        ],
        'tratamiento'=>[
            'required'=>'El tipo de incidencia debe ser especificado',
        ],
