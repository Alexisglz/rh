<div class="modal fade" id="modalEditSolicitud" role="dialog">
    {!! Form::open(['id'=>'form_edit_solicitud','route'=>'altas.store','method'=>'POST','files'=>true,'enctype'=>"multipart/form-data"]) !!}
            ...
            <div class="modal-body">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::textarea('motivo', null, ['class' => 'form-control','rows'=>'4','style'=>'overflow: hidden; resize: none;']) !!}
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                {!! Form::textarea('herramientas_almacen', null, ['class' => 'form-control','rows'=>'5','style'=>'overflow: hidden; resize: none;','placeholder'=>'Detalle de las herramientas de almacen necesitadas']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::textarea('actividad', null, ['class' => 'form-control req_common','rows'=>'2','style'=>'overflow: hidden; resize: none;']) !!}
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
