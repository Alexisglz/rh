    ...
    <div class="modal-dialog modal-lg" id="mdialTamanio" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{__('Nuevo Empleado')}}</h5>
            </div>
                ...
                <div class="modal-body body-permisos">
                        ...
                        <div class="form-group col-md-12">
                            <div class="form-row">
                                <div class="col-md-4">
                                    ...
                                    {!! Form::select('cliente',$clientes,null,['class'=>'form-control select_wbs req_common','data-id'=>1,'id'=>'cliente','placeholder'=>'CLIENTE']) !!}
                                </div>
                                <div class="col-md-4">
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            ...
                            <td>Coordinador:</td>
                            <td>
                                {!! Form::select('coordinadores',$coordinadores,null,['class'=>'form-control','data-id'=>'coordinadores','id'=>'coordinadores','placeholder'=>'--SELECCIONE--']) !!}
                            </td>
                        </tr>
                        <tr>
