...
<?php $__env->startSection('contenido'); ?>
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">
                ...
                <?php echo e(__('LISTADO DE EMPLEADOS')); ?>

            </h3>

            <br>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access',[\App\User::class,'autorizar_empleado'])): ?>
                <div class="row" style="margin-left: 0">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#mdialTamanio"><?php echo e(__('Agregar')); ?></button>
                </div>
            <?php endif; ?>
            <br>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access',[\App\User::class,'exportar_empleados'])): ?>
                <div class="row" style="padding-top: 5px;border-top: 1px solid lightgrey;">
                    <form class="form-inline" style="margin-top: 5px;">
                        ...
                        <button id="excel" type="button" onclick="ExcelEmpleados();" class="btn btn-success pull-right"><?php echo e(__('Exportar')); ?>

                        </button>
                    </form>
                </div>
            <?php endif; ?>
            <div class="row form-inline" style="padding-top: 5px;border-top: 1px solid lightgrey;">
                <div class="col-10" style="margin-top: 5px;">
                    <input class="form-control input-sm" title="Buscar por id" id="search_id" name="search_id" style="width: 5%" placeholder="ID">
                    <input class="form-control input-sm" title="Buscar por numero de empleado" id="num_emp" name="num_emp" style="width: 9%" placeholder="No. Emp">
                    ...
                    <input class="form-control input-sm" title="Buscar por project definition" id="search_pd" name="search_pd" style="width: 8%" placeholder="PD">
                    <a id="search" class="btn btn-primary btn-md" title="Buscar" style="color: white">
        ...
        <div class="card-body table-responsive">
            <table class="table table-active" id="empleados-table"
                ...
                <tr>
                    ...
                    <th><?php echo e(__('Solicitar baja')); ?></th>
                    <th><?php echo e(__('No.Empleado')); ?></th>
                    <th><?php echo e(__('Nombre')); ?></th>
                    <th><?php echo e(__('Coordinador')); ?></th>
                    <th><?php echo e(__('PD')); ?></th>
                    <th><?php echo e(__('Puesto')); ?></th>
                    <th><?php echo e(__('Segmento')); ?></th>
                    <th><?php echo e(__('Sueldo IMSS')); ?></th>
                    <th><?php echo e(__('Sueldo Asimilado')); ?></th>
                    <th><?php echo e(__('Estatus')); ?></th>
                    <th><?php echo e(__('Fecha alta')); ?></th>
                </tr>
                </thead>
            </table>
        </div>
    </div>
    <?php echo $__env->make('empleados.modals.editar_empleado', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('empleados.modals.baja_empleado', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <script>
        $(function () {
    ...
    <!-- Modal -->
    <?php echo $__env->make('empleados.modals.nuevo_empleado', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <?php echo Html::script('js/empleados/index.js'); ?>

    <?php echo Html::script('js/empleados/buscar_emp.js?v='.time()); ?>

    <?php echo Html::script('js/validador.js?v='.time()); ?>


    <?php echo Html::script('js/sol_altas/search_wbs.js?v='.time()); ?>

    <?php echo Html::script('js/sol_altas/common.js?v='.time()); ?>
