                        ...
                        <div class="col-md-12">
                            <form id="form_edit_empleado" method="post" action="">
                                ...
                                <div class="row">
                                    ...
                                    <td>
                                        <center>
                                            <?php echo Form::checkbox('recurso_check', 'value', false,['data-toggle'=>'toggle','data-on'=>'SI','data-off'=>'NO','id'=>'recurso_check','data-onstyle'=>'primary','data-offstyle'=>'success']);; ?>
